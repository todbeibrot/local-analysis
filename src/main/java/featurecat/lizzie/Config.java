...
public class Config {
  ...
  public Config() throws IOException {
    ...
    wallDistance = la.optInt("wall-distance", 3);
    playerInside = la.optInt("player-inside", 0);
    playerToMove = la.optInt("player-to-move", 0);
  ...
  private JSONObject createDefaultConfig() {
    ...
    la.put("player-inside", 0);
    la.put("allow-Ko", false);
