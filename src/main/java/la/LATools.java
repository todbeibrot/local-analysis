...
public class LATools extends JTabbedPane{
	...
	LATools(){
		...
		rdoPlay.addActionListener(new ActionListener() {
	        @Override
		...
		rdoSetStone.addActionListener(new ActionListener() {
	        @Override
	        public void actionPerformed(ActionEvent e) {
		...
		rdoDeleteStone.addActionListener(new ActionListener() {
	        @Override
	        public void actionPerformed(ActionEvent e) {
		...
		rdoSetGroupVertical.addActionListener(new ActionListener() {
	        @Override
	        public void actionPerformed(ActionEvent e) {
		...
		rdoSetGroupHorizontal.addActionListener(new ActionListener() {
	        @Override
	        public void actionPerformed(ActionEvent e) {
...
//		tools1Tab.add(rdoSetLine);
		...
		rdoPlayerInsideBlack.addActionListener(new ActionListener() {
	        @Override
	        public void actionPerformed(ActionEvent e) {
		...
		rdoPlayerInsideWhite.addActionListener(new ActionListener() {
	        @Override
	        public void actionPerformed(ActionEvent e) {
	            if(Lizzie.frame.localAnalysisFrame.localAnalysis.isPlayerInsideBlack()) {
	            	Lizzie.frame.localAnalysisFrame.localAnalysis.changePlayerInsideBlack();
		...
		rdoPlayerToMoveBlack.addActionListener(new ActionListener() {
	        @Override
	        public void actionPerformed(ActionEvent e) {
		...
		rdoPlayerToMoveWhite.addActionListener(new ActionListener() {
	        @Override
	        public void actionPerformed(ActionEvent e) {
	            if(Lizzie.frame.localAnalysisFrame.localAnalysis.isBlackToMove()) {
	            	Lizzie.frame.localAnalysisFrame.localAnalysis.changeBlackToMove();
		...
		rdoAllowKoYes.addActionListener(new ActionListener() {
	        @Override
	        public void actionPerformed(ActionEvent e) {
		...
		rdoAllowKoNo.addActionListener(new ActionListener() {
	        @Override
	        public void actionPerformed(ActionEvent e) {
	            if(Lizzie.frame.localAnalysisFrame.localAnalysis.isAllowKo()) {
	            	Lizzie.frame.localAnalysisFrame.localAnalysis.changeAllowKo();
		...
		txtAddPoints = new JFormattedTextField(
...
//	 	tools2Tab.add(txtMarkAlive);
		...
		txtWallDistance = new JFormattedTextField(
	 		    new InternationalFormatter(nf) {
	 		        protected DocumentFilter getDocumentFilter() {
	 		            return filter;
	 		        }
	...
	public void showTools() {
	    ...
	    txtWallDistance.setText(String.valueOf(Lizzie.frame.localAnalysisFrame.localAnalysis.getWallDistance()));
	}
