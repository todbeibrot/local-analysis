...
public class LocalAnalysisDialog extends JDialog {
  ...
  public LocalAnalysisDialog(String coords1, String coords2) {
    ...
    if (Lizzie.frame.localAnalysisFrame.tools.allowKoThreats) {
      JLabel lblBlackKoThreats = new JLabel("Ko Threats For Black");
      ...
      txtBlackKoThreats.setText(
          String.valueOf(Lizzie.frame.localAnalysisFrame.tools.getBlackKoThreats()));
    } else {
      blackKoThreats = 0;
    }
    ...
    JLabel nothing =
        new JLabel(
            ""); // necessary for some reasons. else the last element will be at the wrong place
