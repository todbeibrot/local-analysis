...
public class LABoardData {
  ...
  public static LABoardData empty(int width, int height) {
  ...
  public void tryToClearBestMoves() {
    ...
    if (Lizzie.frame.localAnalysisFrame.leelaz.isKataGo) {
      Lizzie.frame.localAnalysisFrame.leelaz.scoreMean = 0;
      Lizzie.frame.localAnalysisFrame.leelaz.scoreStdev = 0;
    }
  }
  ...
  public void tryToSetBestMoves(List<MoveData> moves) {
    ...
    if (Lizzie.frame.localAnalysisFrame.leelaz.isKataGo) {
      Lizzie.frame.localAnalysisFrame.leelaz.scoreMean = moves.get(0).scoreMean;
      Lizzie.frame.localAnalysisFrame.leelaz.scoreStdev = moves.get(0).scoreStdev;
    }
  }
  ...
  public void sync(LABoardData data) {
  ...
  public LABoardData clone() {
    LABoardData data = LABoardData.empty(19, 19);
    data.sync(this);
    return data;
  }
