...
public class LAVariationTree {
  ...
  public Optional<BoardHistoryNode> draw(
    ...
    curMove = Lizzie.frame.localAnalysisFrame.board.getHistory().getCurrentHistoryNode();
  ...
  public void onClicked(int x, int y) {
    if (area.contains(x, y)) {
      ...
      node.ifPresent(n -> Lizzie.frame.localAnalysisFrame.board.moveToAnyPosition(n));
    }
  }
